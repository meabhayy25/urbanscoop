            ...
            >
              ...
              <div className="p-3 bg-white border-t border-gray-100 flex items-center space-x-2">
                ...
                <button 
                  ...
                  className="bg-primary-600 text-white p-2.5 rounded-full hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg transition-all active:scale-95 flex items-center justify-center"
                >
